...
export function NavigationSection({ data }: { data?: NavigationSectionData }) {
    ...
    return (
        <nav
            ...
            className={`fixed left-0 right-0 z-50 transition-all duration-300 ${isScrolled || isMobileMenuOpen ? "bg-background/95 backdrop-blur-md shadow-lg" : "bg-transparent"
                }`}
        >
